...
export default class LFPToC extends HTMLElement {
    ...
    #collectHeadings() {
        ...
        return root.querySelectorAll(this.minLevel === 0 && this.maxLevel === 0 && isValidAttr('add-items', this) ? this.getAttribute('add-items') : this.#createSelectorStr());
    }
    #setId(headings) {
        let ids = {};
    ...
    #createListElement(headings, idx) {
        ...
        let list = document.createElement(isAlone() || isValidAttr('no-numeration', this, true) ? 'ul' : 'ol');
